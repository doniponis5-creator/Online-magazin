...
/*
 * Фирменные знаки Telegram и WhatsApp — только чтобы человек сразу видел,
 * в каком приложении искать код. Рисуются своими цветами и не подчиняются
 * currentColor: узнаваемость тут важнее единства палитры.
 */
...
export function IconWhatsApp({ size = 20, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden {...props}>
      ...
      <path
        d="M12 5.2a6.7 6.7 0 0 0-5.7 10.2l-.9 3.4 3.5-.9A6.7 6.7 0 1 0 12 5.2Zm0 1.5a5.2 5.2 0 0 1 4.4 8 5.2 5.2 0 0 1-6.6 1.8l-.3-.1-1.7.4.5-1.6-.2-.3A5.2 5.2 0 0 1 12 6.7Z"
        fill="#fff"
      />
      <path
        d="M9.9 9.2c-.1-.3-.2-.3-.4-.3h-.4c-.1 0-.4.1-.6.3-.2.3-.7.7-.7 1.7s.7 2 .8 2.1c.1.1 1.4 2.3 3.5 3.1 1.7.7 2.1.6 2.5.5.4 0 1.2-.5 1.4-1 .2-.5.2-.9.1-1l-.6-.3-1.2-.6c-.2-.1-.3 0-.4.1l-.6.7c-.1.1-.2.2-.4.1-.2-.1-.9-.3-1.7-1.1-.6-.5-1-1.2-1.2-1.4-.1-.2 0-.3.1-.4l.3-.4c.1-.1.1-.2.2-.4v-.3l-.7-1.4Z"
        fill="#fff"
      />
    </svg>
  )
