...
const ASK_PHONE: Say = {
  ...
  ky: 'Албетте, жетекчилик сизге чалат. Телефон номериңизди жазыңыз, мисалы 0555 123456.',
  uz: 'Албатта, рахбарият сизга кунгирок килади. Телефон ракамингизни ёзинг, масалан 0555 123456.',
}
...
const SENT: Say = {
  ...
  ky: 'Даяр — жетекчиликке өткөрдүм, иш убагында сизге чалат. Азырынча бул жерден сурай бериңиз.',
  uz: 'Тайёр — рахбариятга айтиб куйдим, иш вактида сизга кунгирок килишади. Хозирча шу ерда сурашда давом этишингиз мумкин.',
}
