...
function done(total: number, orderId: string, payUrl: string, lang: TalkLang): string {
  ...
  const say: Say = {
    ...
    ky: `Даяр! Заказ ${orderId}, төлөмгө ${sum}.\n\nТөлөө: ${payUrl}\n\nШилтеме O!Деньги барагын ачат — өз банкыңыздын тиркемесинен төлөңүз. Төлөгөнүңүздөн кийин жетекчилик байланышып, качан жеткирерин келишет.`,
    uz: `Тайёр! Буюртма ${orderId}, тулов ${sum}.\n\nТулаш: ${payUrl}\n\nХавола O!Деньги сахифасини очади — уз банкингиз иловасидан туланг. Тулаганингиздан кейин рахбарият сиз билан богланиб, качон етказишни келишади.`,
  }
