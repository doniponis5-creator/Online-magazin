...
function hello(lang: Lang): string {
  return lang === 'ky'
    ? 'Ассаламу алейкум! Мен Smart Centr дүкөнүнүн кеңешчисимин. Товарлар, баалар, жеткирүү жана бонустар боюнча сураңыз. Кыргызча, орусча жана өзбекче жооп берем.'
    : 'Ассаламу алейкум! Я консультант магазина Smart Centr. Спрашивайте про товары, цены, доставку и бонусы. Отвечаю по-кыргызски, по-русски и по-узбекски.'
}
