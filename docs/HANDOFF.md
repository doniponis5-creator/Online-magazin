...
- Панель сайта (форма `ПанельСайта`): сводка по сайту и настройки сайта прямо из 1С.
  - Сводка: заказы (сегодня / 7 дней / всего, суммы оплат), что с заказами сейчас (ждут оплаты, оплачены и ждут 1С, проведены, с ошибкой, отменены), бонусами оплачено, каталог (товаров, из них с ценой, готовы к продаже, когда обновлён), покупатели, состояние каналов кода (Telegram и запасной WhatsApp — живой опрос Green API).
