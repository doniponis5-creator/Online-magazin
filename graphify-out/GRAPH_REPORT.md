...
## Summary
- 1888 nodes · 4096 edges · 183 communities (111 shown, 72 thin omitted)
...
## Communities (183 total, 72 thin omitted)
...
Cohesion: 0.10
Nodes (25): POST(), BonusHistoryItem, call(), CodeChannel, CustomerApiError, CustomerOrderItem, CustomerProfile, DEMO_BALANCE (+17 more)
...
Cohesion: 0.13
Nodes (24): CartPage(), CheckoutPage(), FieldErrors, OrderView(), src_components_account, CartReminder(), CustomerLogin(), Step (+16 more)
...
Cohesion: 0.12
Nodes (28): CategoryTiles(), InfoStrip(), NightBanner(), ProductSection(), BrandLogo(), hasBrandImage(), LOGOS, LogoSpec (+20 more)
...
Cohesion: 0.20
Nodes (16): products, catalogForQuestion(), expand(), InstallmentBrief, isInStock(), normalize(), productLine(), productName() (+8 more)

### Community 90 - "product/[id]/page.tsx"
Cohesion: 0.14
...
Cohesion: 0.14
Nodes (11): widths, ref_node_fs, fs, keys, path, root, sharp, fs (+3 more)

### Community 92 - "FavoritesProvider.tsx"
Cohesion: 0.48
...
### Community 96 - "sku.ts"
Cohesion: 0.11
Nodes (17): ProductDetail(), colorHexOf(), comboVariant(), defaultColorKey(), defaultMemoryKey(), demoProducts, Product, ProductVariant (+9 more)
...
Cohesion: 0.16
Nodes (19): CustomerBrief, allOutSay, Answer, bonusText(), dayText(), foundSay, helloText(), installmentText() (+11 more)

### Community 101 - "sync-catalog.mjs"
Cohesion: 0.22
Nodes (8): ref_node_crypto, ref_node_url, apiUrl, CATALOG, fileEnv, log(), main(), ROOT

### Community 102 - "ref_server_only"
Cohesion: 0.27
