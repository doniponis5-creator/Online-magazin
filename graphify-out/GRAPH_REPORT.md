...
## Corpus Check
- 683 files · ~14,956,564 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 102 file(s) not represented in the graph (top: .img 28, .bin 15, .xml 13)

## Summary
- 3266 nodes · 7897 edges · 249 communities (149 shown, 100 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 140 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b464dc4`
...
- scripts
- import_small_appliance_batch2.py
- telegram/order.ts
- Adapter
- update-all.sh
...
- android.os.Bundle
- AppLockPlugin.java
- import_iron_enrichment.py
- import_stoves_enrichment.py
- engine.ts
...
- import_separator_enrichment.py
- import_vacuum_order_20260922.py
- photo.ts
- normalize_washer_photos.cjs
- com.getcapacitor.PluginCall
- import_mini_oven_enrichment.py
- pathlib
- import_refrigerator_enrichment.py
- Capacitor
- import_gepard_m2_enrichment.py
- refresh_asko_k25gsr_photos.py
- import_steamer_enrichment.py
- import_baoyu_gt001.py
- import_television_enrichment.py
- normalize_vacuum_photos.cjs
- import_levo_lv80luxt.py
- shop_models.py
- FilterSelect.tsx
- photo-sources.ts
- update_lg_text.py
...
- onec_credentials
- route-helpers.ts
- Google Business Profile — Smart Centr (Google xaritasi)
- Холодильники и морозильники — подготовка к сайту
...
- asko-k25gsr/STATUS.md
- baoyu-gt001/STATUS.md
- builtins-enrichment/STATUS.md
- hantaji-h112/STATUS.md
- iron-enrichment/README-uz.md
- jack-a2c/STATUS.md
- jack-a4b/STATUS.md
- levo-lv80luxt/STATUS.md
- midea-facm1001/STATUS.md
- mini-ovens-enrichment/README-uz.md
- samsung-vc20m257/STATUS.md
- vacuum-order-20260922/STATUS.md
- ref_next_headers
- ref_next_image
- ref_next_navigation
- ref_next_server
...
1. `KitchenPlanner()` - 81 edges
2. `useI18n()` - 80 edges
3. `KitchenEngine` - 78 edges
4. `three` - 65 edges
5. `onec_credentials()` - 52 edges
6. `next` - 50 edges
...
## Communities (249 total, 100 thin omitted)

### Community 0 - "kitchen.test.ts"
Cohesion: 0.09
Nodes (32): KitchenPage(), SIDE_SHARE, applianceFromProduct(), defaultPick(), find(), FINISH_WORDS, finishOf(), fridgeKind() (+24 more)
...
### Community 3 - "next"
Cohesion: 0.07
Nodes (40): Sayt tomonida qilingan (22.09.2026), nextConfig, next, generateMetadata(), generateMetadata(), generateMetadata(), generateMetadata(), META (+32 more)
...
Cohesion: 0.07
Nodes (46): CheckoutPage(), FieldErrors, OrderView(), src_components_account, AccountView(), formatDate(), useCustomer(), BonusReminder() (+38 more)

### Community 8 - "layout.ts"
Cohesion: 0.07
Nodes (52): Dropped(), ALL_WALLS, allowedOn(), canChangeWall(), clampWindow(), companions(), copy(), CORNER_W (+44 more)

### Community 9 - "spec.ts"
Cohesion: 0.07
Nodes (39): appliance(), CARCASS, DRAWING_CSS, DrawingLabels, elevationSvg(), esc(), fmt(), front() (+31 more)
...
Cohesion: 0.10
Nodes (37): react, A09 · P2 — Дизайн ҳужжати ва токенлар амалдаги бош баннердан ортда қолган, frameUrl(), Hero3D(), src_components_home_story, HomeStory(), base(), IconArrowDown() (+29 more)
...
Cohesion: 0.12
Nodes (19): CoreImage.CIFilterBuiltins, Double, BonusCardData, BonusCardStore, .query, BonusCardView, .body, .closeButton (+11 more)

### Community 18 - "KitchenPlanner.tsx"
Cohesion: 0.05
Nodes (58): src_components_kitchen_kitchen, colorSwatch(), CORE, FLEX, fmt(), hasWebGL(), iconProps, isStacked() (+50 more)

### Community 19 - "shop_admin.py"
Cohesion: 0.09
Nodes (48): app_core_redis, app_models, AsyncClient, Интернет-магазин Smart Centr: заказы с сайта (O!Деньги → 1С)., account_delete(), AccountDelete, _as_list(), _attention() (+40 more)

### Community 21 - "@playwright/test"
Cohesion: 0.12
Nodes (13): widths, ref_node_assert, @playwright/test, assert, { chromium }, fs, dynamic, esc() (+5 more)
...
Cohesion: 0.14
Nodes (41): csv, datetime, main(), Почему товара нет на сайте — только чтение, база 1С не меняется. На сайт уходит…, reason(), connect(), detect_brand(), export_photos() (+33 more)
...
Cohesion: 0.18
Nodes (18): getpass, ask_credentials(), _configure(), configure_extension(), copy_base(), designer(), _detect(), detect_variant() (+10 more)
...
Cohesion: 0.08
Nodes (40): fromJson(), withoutIds(), budgetFrom(), cheaperThan(), NOT_UNIT, PATTERNS, THOUSAND, catalogForQuestion() (+32 more)
...
### Community 50 - "build.ts"
Cohesion: 0.12
Nodes (43): addFront(), anchor(), Anim, applianceDims(), assemble(), backsplash(), BASE_DIMS, baseModule() (+35 more)

### Community 51 - "CatalogStore"
Cohesion: 0.17
Nodes (9): CAPBridgedPlugin, CatalogStore, .file, .folder, .updatedAt, OfflineCatalogPlugin, CAPPluginCall, CAPPluginMethod (+1 more)
...
Cohesion: 0.09
Nodes (45): asyncio, Консультант, Прочитать свежие входящие WhatsApp и отметить коды входа, которые прислали…, _scan_wa_logins(), _site_base_url(), _site_secret(), _answer(), _ask_for_text() (+37 more)

### Community 57 - "whatsapp/route.ts"
Cohesion: 0.53
...
Cohesion: 0.07
Nodes (6): BuildInput, Built, easeInOut(), KitchenEngine, Dims, SlotKind
...
### Community 83 - "Product"
Cohesion: 0.12
Nodes (24): dynamic, GET(), dynamic, GET(), productsFromOneC(), Product, products, Cache (+16 more)
...
### Community 88 - "patch_client_walogin.py"
Cohesion: 0.50
Nodes (4): main(), patch(), Path, Кабинет SBonus — страница входа: кнопка «Войти через WhatsApp». Правит…
...
Cohesion: 0.13
Nodes (20): src_components_kitchen_kitchen_promo, KitchenPromo(), swatch(), SWATCH_STYLES, TEXT, FinishLook, RoomLook, FrontTexture (+12 more)

### Community 92 - "HomeMerchandising.tsx"
Cohesion: 0.09
Nodes (35): CategoryTiles(), HomePage(), InfoStrip(), NightBanner(), ProductSection(), BrandLogo(), hasBrandImage(), LOGOS (+27 more)
...
### Community 98 - "PhotoTracer"
Cohesion: 0.12
Nodes (7): three-gpu-pathtracer, DAY, Look, NIGHT, PhotoLights, PhotoTracer, PrepareOpts

### Community 99 - "share.ts"
Cohesion: 0.08
Nodes (41): allowed(), BASE_FRONTS, BY_CODE, CODE, DRAWER_PARTS, frontsFromQuery(), frontsToQuery(), isUpperKey() (+33 more)
...
### Community 101 - "three"
Cohesion: 0.15
Nodes (46): three, chimneyHood(), cm(), dishwasherInside(), faucet(), fridge(), FridgeDoor, fridgeDoors() (+38 more)
...
Cohesion: 0.13
Nodes (29): app_core_database, fastapi, _as_jpeg(), chat_extra_items(), photos_index(), public_photo(), AsyncSession, Request (+21 more)
...
### Community 105 - "CartProvider.tsx"
Cohesion: 0.10
...
Cohesion: 0.07
Nodes (26): ref_node_fs, sharp, fs, path, root, sharp, fs, keys (+18 more)
...
### Community 130 - "ref_node_path"
Cohesion: 0.08
Nodes (17): ref_node_path, path, root, sharp, jobs, path, root, sharp (+9 more)
...
### Community 134 - "import_small_appliance_batch2.py"
Cohesion: 0.20
Nodes (5): importlib_util, os, Безопасно загружает вторую партию карточек малой техники в 1С (TH-213, SK-234)., Безопасно загружает только одобренные карточки малой техники в 1С., Safely import the manually approved vacuum package into 1C.

### Community 135 - "telegram/order.ts"
Cohesion: 0.08
Nodes (52): vitest, ASK_PHONE, BAD_PHONE, CALL_INTENT, Draft, drafts, FAILED, hasLead() (+44 more)
...
### Community 150 - "useI18n"
Cohesion: 0.12
Nodes (30): CartPage(), FavoritesPage(), generateMetadata(), ProductPage(), AddToCartButton(), BottomNav(), CartReminder(), FavoriteButton() (+22 more)

### Community 151 - "assistant/route.ts"
Cohesion: 0.14
Nodes (21): ref_server_only, dynamic, ipOf(), POST(), readImage(), seen, tooOften(), dynamic (+13 more)
...
### Community 156 - "normalize_small_appliance_photos.cjs"
Cohesion: 0.09
Nodes (21): ref_fs, ref_path, fs, meta, output, path, review, root (+13 more)
...
### Community 160 - "AppLockPlugin.java"
Cohesion: 0.10
...
### Community 161 - "import_iron_enrichment.py"
Cohesion: 0.35
Nodes (10): apply_one(), connect(), load_package(), main(), Безопасно загружает подтверждённые карточки утюгов в 1С. Сначала полный прогон…, ref_by_code(), run_base(), action() (+2 more)

### Community 162 - "import_stoves_enrichment.py"
Cohesion: 0.35
Nodes (10): apply_one(), connect(), load_package(), main(), Безопасно загружает подтверждённые карточки плит в 1С. Сначала полный прогон…, ref_by_code(), run_base(), action() (+2 more)

### Community 163 - "engine.ts"
Cohesion: 0.09
Nodes (22): three, buildKitchen(), CabInfo, CEILING_LAYER, WALL_H, WINDOW, DAY, DragPreview (+14 more)

### Community 164 - "BonusCardPlugin.java"
Cohesion: 0.18
Nodes (11): android.graphics.drawable.GradientDrawable, decimalformat, decimalformatsymbols, insets, intent, jsobject, locale, simpledateformat (+3 more)

### Community 165 - "ref_node_crypto"
Cohesion: 0.15
Nodes (13): ref_node_crypto, cache, Entry, GET(), reply(), dailyLimit(), day, dayBudgetLeft() (+5 more)
...
### Community 175 - "android.content.Context"
Cohesion: 0.24
...
### Community 177 - "import_washer_enrichment.py"
Cohesion: 0.25
Nodes (12): main(), Безопасно загружает подготовленную встраиваемую технику в 1С. Использует тот же…, apply_one(), connect(), load_package(), main(), Безопасно загружает подготовленные карточки стиральных машин в 1С. Сначала…, ref_by_code() (+4 more)

### Community 178 - "import_separator_enrichment.py"
Cohesion: 0.35
Nodes (10): apply_one(), connect(), load_package(), main(), Безопасно загружает подтверждённые карточки утюгов в 1С. Сначала полный прогон…, ref_by_code(), run_base(), action() (+2 more)

### Community 179 - "import_vacuum_order_20260922.py"
Cohesion: 0.43
Nodes (6): apply_one(), connect(), Import the five vacuum cards from the supplier order into 1C., ref_by_code(), run(), save_backup()

### Community 180 - "photo.ts"
Cohesion: 0.39
Nodes (7): cache, decode(), loadPhoto(), Photo, photoUrl(), sideShare(), trim()

### Community 181 - "normalize_washer_photos.cjs"
Cohesion: 0.20
Nodes (10): cards, fs, main(), meta, output, path, review, root (+2 more)

### Community 182 - "com.getcapacitor.PluginCall"
Cohesion: 0.14
Nodes (11): AppLockPlugin, BonusCardPlugin, OfflineCatalogPlugin, com.getcapacitor.annotation.CapacitorPlugin, com.getcapacitor.Plugin, com.getcapacitor.PluginCall, com.getcapacitor.PluginMethod, file (+3 more)

### Community 183 - "import_mini_oven_enrichment.py"
Cohesion: 0.35
Nodes (10): apply_one(), connect(), load_package(), main(), Безопасно загружает проверенные карточки мини-печей в 1С. Сначала полный прогон…, ref_by_code(), run_base(), action() (+2 more)

### Community 184 - "pathlib"
Cohesion: 0.05
Nodes (43): Листы проверки: только кадрирование/одинаковая высота, без ретуши модели., bs4, concurrent_futures, html, io, json, pathlib, pil (+35 more)

### Community 185 - "import_refrigerator_enrichment.py"
Cohesion: 0.35
Nodes (10): apply_one(), connect(), load_package(), main(), Безопасно загружает подготовленные карточки стиральных машин в 1С. Сначала…, ref_by_code(), run_base(), action() (+2 more)

### Community 186 - "Capacitor"
Cohesion: 0.29
Nodes (6): Capacitor, SceneDelegate, UIWindow, UIKit, UIResponder, UIWindowSceneDelegate

### Community 187 - "import_gepard_m2_enrichment.py"
Cohesion: 0.16
Nodes (21): argparse, apply_one(), connect(), load_package(), main(), Безопасно загружает подтверждённые карточки электровелосипедов в 1С. Сначала…, ref_by_code(), run_base() (+13 more)

### Community 188 - "refresh_asko_k25gsr_photos.py"
Cohesion: 0.42
Nodes (8): check_package(), connect(), item_ref(), main(), Replace only ASKO K25GSR photos after a successful test-base transaction., replace_photos(), run_base(), save_backup()

### Community 189 - "import_steamer_enrichment.py"
Cohesion: 0.35
Nodes (10): apply_one(), connect(), load_package(), main(), Безопасно загружает подтверждённые карточки отпаривателей в 1С. Сначала полный…, ref_by_code(), run_base(), action() (+2 more)

### Community 190 - "import_baoyu_gt001.py"
Cohesion: 0.52
Nodes (6): apply(), backup(), connect(), Import approved Baoyu GT-001 text and photos into 1C., ref(), run()

### Community 191 - "import_television_enrichment.py"
Cohesion: 0.35
Nodes (10): apply_one(), connect(), load_package(), main(), Безопасно загружает подготовленные карточки телевизоров в 1С. Сначала полный…, ref_by_code(), run_base(), action() (+2 more)

### Community 192 - "normalize_vacuum_photos.cjs"
Cohesion: 0.20
Nodes (10): cards, fs, main(), meta, output, path, review, root (+2 more)

### Community 193 - "import_levo_lv80luxt.py"
Cohesion: 0.52
Nodes (6): apply(), backup(), connect(), get_ref(), Import the LEVO LV-80LUX-T card into 1C with approved text and photos., run()
...
### Community 195 - "FilterSelect.tsx"
Cohesion: 0.38
Nodes (6): src_components_filter_select, FilterSelect(), choose(), keyboard(), show(), Option

### Community 196 - "photo-sources.ts"
Cohesion: 0.50
Nodes (3): PEXELS_LICENSE, PhotoSource, photoSources

### Community 197 - "update_lg_text.py"
Cohesion: 0.36
Nodes (8): apply(), backup(), connect(), Add approved Russian descriptions and characteristics to the 13 LG cards., ref_by_code(), run(), action(), transaction()

### Community 198 - "make-app-icons.mjs"
Cohesion: 0.24
Nodes (9): androidDir, circle(), DENSITIES, glyph(), iconSet, root, splashSet, square() (+1 more)

### Community 199 - "orders/order.ts"
Cohesion: 0.15
Nodes (16): POST(), demoProducts, SESSION_DAYS, createOrder(), applyBonus(), DeliveryMethod, deliveryPriceFor(), OrderError (+8 more)

### Community 200 - "products.ts"
Cohesion: 0.06
Nodes (31): dynamic, SnapshotItem, ProductDetail(), askText(), ProductPurchase(), StockLine(), WarrantyBadge(), warrantyText() (+23 more)

### Community 201 - "Блендеры, мясорубки, чопперы и швейные машины"
Cohesion: 0.29
Nodes (6): Блендеры, мясорубки, чопперы и швейные машины, Не загружено (без точного подтверждения) — 8 позиций, Партия 2 — 21.09.2026, загружено в рабочую 1С: 2 карточки, Партия 3 — 22.09.2026, загружено в рабочую 1С: 3 карточки, Партия 4 — 22.09.2026, загружено в рабочую 1С: 1 карточка, Требуют уточнения

### Community 204 - "prepare_builtins_queue.py"
Cohesion: 0.32
...
### Community 205 - "onec_credentials"
Cohesion: 0.06
Nodes (46): Кабинет SBonus (cabinet.smartcentr.store): вход через WhatsApp «наоборот».…, Кабинет SBonus — страница входа: форма «код по номеру» свёрнута. После…, main(), Проверка остатков по рассрочке перед выкатом — ничего не меняет и никуда не…, som(), apply(), backup(), connect() (+38 more)

### Community 206 - "route-helpers.ts"
Cohesion: 0.21
Nodes (16): GET(), POST(), currentSession(), POST(), registerPushDevice(), CustomerSession, decodeNativeKey(), decodeSession() (+8 more)

### Community 208 - "Google Business Profile — Smart Centr (Google xaritasi)"
Cohesion: 0.50
Nodes (3): Google Business Profile — Smart Centr (Google xaritasi), Nusxalanadigan ma'lumot, Qadamlar

### Community 209 - "Холодильники и морозильники — подготовка к сайту"
Cohesion: 0.40
Nodes (4): Партия 1 — подготовлено и записано в 1С, Первый этап поиска, Позиции в наличии, Холодильники и морозильники — подготовка к сайту

### Community 210 - "Подготовка карточек стиральных машин для 1С"
Cohesion: 0.40
...
### Community 211 - "orders/gateway.ts"
Cohesion: 0.18
Nodes (15): POST(), GET(), mockSpend(), API_URL, callServer(), CreateResult, getOrder(), globalStore (+7 more)

### Community 212 - "startSession"
Cohesion: 0.23
Nodes (12): POST(), startSession(), POST(), POST(), call(), CustomerApiError, demoProfile(), maxBonusSpend() (+4 more)

### Community 250 - "errorResponse"
Cohesion: 0.50
Nodes (6): clientIp(), errorResponse(), POST(), POST(), sendCode(), waLoginStart

### Community 251 - "getProfile"
Cohesion: 0.27
Nodes (9): POST(), DELETE(), GET(), endSession(), dynamic, GET(), deleteAccount(), getProfile() (+1 more)

## Knowledge Gaps
- **569 isolated node(s):** `customer`, `phone`, `laptop`, `catalog`, `order` (+564 more)
