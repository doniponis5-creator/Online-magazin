...
- smartcentr-site/src/components/kitchen/three/photoreal.ts
...
## Communities (291 total, 106 thin omitted)

### Community 0 - "kitchen.test.ts"
Cohesion: 0.08
Nodes (35): cache, decode(), loadPhoto(), Photo, photoUrl(), SIDE_SHARE, sideShare(), trim() (+27 more)
...
Cohesion: 0.05
Nodes (48): nextConfig, SECURITY_HEADERS, ref_next, nextConfig, SECURITY_HEADERS, generateMetadata(), generateMetadata(), generateMetadata() (+40 more)
...
Cohesion: 0.06
Nodes (56): CheckoutPage(), FieldErrors, OrderView(), src_components_account, AccountView(), formatDate(), useCustomer(), BonusReminder() (+48 more)

### Community 8 - "src/lib/kitchen/layout.ts"
Cohesion: 0.05
Nodes (82): Dropped(), ALL_WALLS, allowedOn(), canChangeWall(), CEILING, clampWindow(), COLUMN_HEIGHT, companions() (+74 more)
...
### Community 11 - "src/lib/customer/session.ts"
Cohesion: 0.18
...
Cohesion: 0.06
Nodes (58): AccountReviews(), ErrorKey, Photo, ReviewForm(), addPhotos(), ReviewLoginHint(), Cached, photoUrl() (+50 more)
...
### Community 15 - "_post"
Cohesion: 0.10
Nodes (35): app_payments, AsyncClient, httpx, _b64(), _bundle(), _devices(), _drop(), enabled() (+27 more)
...
Cohesion: 0.03
Nodes (81): src_components_kitchen_kitchen, chromeIntent(), colorSwatch(), CORE, Fail3d, FLEX, fmt(), hasWebGL2() (+73 more)
...
### Community 21 - "src/lib/assistant/respond.ts"
Cohesion: 0.09
Nodes (43): dynamic, POST(), dynamic, POST(), followUp, ASK_PHONE, BAD_PHONE, CALL_INTENT (+35 more)
...
Cohesion: 0.11
Nodes (32): dynamic, POST(), productsFromOneC(), cancelLead(), tooOften(), Cache, catalogNow(), chatExtraNow() (+24 more)

### Community 26 - "smartcentr-site/src/app/api/feed/google/route.ts"
Cohesion: 0.19
Nodes (12): dynamic, GET(), dynamic, GET(), googleFeedXml(), xml(), absolute(), cell() (+4 more)
...
### Community 35 - "smartcentr-site/src/lib/assistant/respond.ts"
Cohesion: 0.15
Nodes (27): followUp, ChatTurn, hasLead(), lookupIn(), salesCatalogNow(), parseAnswer(), answer(), AssistantReply (+19 more)
...
### Community 39 - "src/components/kitchen/three/appliances.ts"
Cohesion: 0.13
Nodes (46): ref_three_addons_geometries_roundedboxgeometry_js, ref_three_addons_utils_buffergeometryutils_js, chimneyHood(), cm(), dishwasherInside(), faucet(), fridge(), FridgeDoor (+38 more)
...
Cohesion: 0.04
Nodes (72): smartcentr_site_src_components_kitchen_kitchen, chromeIntent(), colorSwatch(), CORE, Fail3d, FLEX, fmt(), hasWebGL2() (+64 more)
...
Cohesion: 0.06
Nodes (46): ref_next_navigation, AboutPage(), generateMetadata(), generateMetadata(), generateMetadata(), generateMetadata(), KitchenPage(), META (+38 more)
...
Cohesion: 0.07
Nodes (19): AddToCartButton(), Gallery(), PinchZoom(), ProductArt(), ProductCard(), ProductDetail(), ProductImage(), smartcentr_site_src_data_categories_categoryname (+11 more)
...
### Community 74 - "src/components/kitchen/three/engine.ts"
Cohesion: 0.07
Nodes (23): ref_three_addons_postprocessing_effectcomposer_js, ref_three_addons_postprocessing_gtaopass_js, ref_three_addons_postprocessing_renderpass_js, buildKitchen(), CEILING_LAYER, WALL_H, WINDOW, DAY (+15 more)
...
Cohesion: 0.06
Nodes (63): CategoryTiles(), HomePage(), InfoStrip(), NightBanner(), ProductSection(), AddToCartButton(), BrandLogo(), hasBrandImage() (+55 more)
...
Cohesion: 0.06
Nodes (53): dynamic, SnapshotItem, CategoryTiles(), InfoStrip(), NightBanner(), ProductSection(), BonusPromo(), BrandLogo() (+45 more)
...
### Community 94 - "smartcentr-site/src/app/robots.ts"
Cohesion: 0.33
...
### Community 99 - "src/components/kitchen/three/build.ts"
Cohesion: 0.10
Nodes (50): addFront(), anchor(), Anim, applianceDims(), assemble(), backsplash(), BASE_DIMS, baseModule() (+42 more)

### Community 100 - "src/lib/assistant/local.ts"
Cohesion: 0.08
Nodes (42): fromJson(), withoutIds(), catalogForQuestion(), storeFacts(), allOutSay, Answer, Audience, AUDIENCE_MARKER (+34 more)

### Community 103 - "shop_catalog.py"
Cohesion: 0.07
Nodes (54): app_core_database, collections, datetime, fastapi, _as_jpeg(), chat_extra_items(), photos_index(), public_photo() (+46 more)

### Community 104 - "smartcentr-site/src/components/kitchen/three/engine.ts"
Cohesion: 0.07
Nodes (31): ref_three, ref_three_addons_controls_orbitcontrols_js, ref_three_addons_environments_roomenvironment_js, ref_three_addons_lights_rectarealightuniformslib_js, ref_three_addons_postprocessing_outputpass_js, ref_three_addons_postprocessing_shaderpass_js, ref_three_addons_postprocessing_unrealbloompass_js, CabInfo (+23 more)

### Community 105 - "products.ts"
Cohesion: 0.05
Nodes (39): dynamic, SnapshotItem, dynamic, GET(), dynamic, GET(), ProductDetail(), src_data_1c_catalog (+31 more)

### Community 106 - "src/lib/orders/gateway.ts"
Cohesion: 0.20
Nodes (14): POST(), GET(), mockSpend(), API_URL, callServer(), CreateResult, getOrder(), globalStore (+6 more)
...
### Community 130 - "smartcentr-site/src/lib/telegram/order.ts"
Cohesion: 0.12
...
Cohesion: 0.08
Nodes (29): CartPage(), CheckoutPage(), FieldErrors, OrderView(), useCustomer(), BonusReminder(), askText(), ProductPurchase() (+21 more)
...
Cohesion: 0.20
Nodes (13): DevGalleryFixturePage(), FavoritesPage(), generateMetadata(), BottomNav(), CartReminder(), FavoriteButton(), getProduct(), FavoritesContext (+5 more)

### Community 152 - "ref_vitest"
Cohesion: 0.13
Nodes (25): ref_vitest, dynamic, POST(), dynamic, esc(), GET(), page(), rowsTable() (+17 more)
...
### Community 156 - "ref_react"
Cohesion: 0.08
Nodes (46): ref_next_link, ref_react, FavoritesPage(), Cached, BottomNav(), FavoriteButton(), frameUrl(), Hero3D() (+38 more)
...
### Community 165 - "src/lib/store.ts"
Cohesion: 0.15
...
### Community 175 - "src/components/ProductPurchase.tsx"
Cohesion: 0.07
Nodes (47): AboutPage(), metadata, ALLOW, ASSISTANTS, PRIVATE, TRAINERS, src_components_assistant_chat, AssistantChat() (+39 more)

### Community 176 - "src/lib/assistant/reply.ts"
Cohesion: 0.10
Nodes (30): budgetFrom(), cheaperThan(), NOT_UNIT, PATTERNS, THOUSAND, CustomerBrief, expand(), InstallmentBrief (+22 more)
...
Cohesion: 0.05
Nodes (66): FinishLook, Mats, RoomLook, allowed(), BASE_FRONTS, BY_CODE, CODE, DRAWER_PARTS (+58 more)
...
Cohesion: 0.09
Nodes (40): dynamic, POST(), ASK_PHONE, BAD_PHONE, CALL_INTENT, cancelLead(), Draft, drafts (+32 more)
...
Cohesion: 0.10
Nodes (22): ref_server_only, allowed, cache, Entry, GET(), reply(), TYPES, smartcentr_site_src_data_1c_adapter (+14 more)

### Community 203 - "smartcentr-site/src/components/AccountView.tsx"
Cohesion: 0.11
Nodes (31): smartcentr_site_src_components_account, AccountView(), formatDate(), CustomerLogin(), Step, smartcentr_site_src_components_home_merchandising, CustomerProfile, AppLockPlugin (+23 more)

### Community 204 - "smartcentr-site/src/lib/assistant/local.ts"
Cohesion: 0.09
Nodes (38): catalogForQuestion(), storeFacts(), allOutSay, Answer, Audience, AUDIENCE_MARKER, bonusText(), dayText() (+30 more)
...
Cohesion: 0.08
Nodes (36): metadata, smartcentr_site_src_components_assistant_chat, AssistantChat(), onKeyDown(), onPickFile(), send(), handoffText(), Hit (+28 more)

### Community 218 - "src/lib/telegram/order.ts"
Cohesion: 0.15
Nodes (20): ASK_ADDRESS, ASK_NAME, ASK_PHONE, ASK_PICK, ASK_WHERE, BAD_PHONE, DEFER, done() (+12 more)
...
### Community 223 - "ref_playwright_test"
Cohesion: 0.11
Nodes (9): ref_fs, ref_path, ref_playwright_test, { chromium }, DIR, fs, path, { chromium } (+1 more)

### Community 224 - "smartcentr-site/src/components/CatalogView.tsx"
Cohesion: 0.11
Nodes (23): metadata, smartcentr_site_src_components_catalog_filters, Badge, BADGES, CatalogView(), CatalogViewInner(), inStock(), normalize() (+15 more)
...
Cohesion: 0.12
Nodes (3): BuildInput, Built, KitchenEngine
...
Cohesion: 0.15
Nodes (18): ref_next_server, POST(), GET(), getInstallment(), mockSpend(), API_URL, callServer(), CreateResult (+10 more)
...
Cohesion: 0.11
Nodes (23): POST(), BonusHistoryItem, call(), CodeChannel, CustomerApiError, CustomerOrderItem, DEMO_BALANCE, DEMO_CODE (+15 more)

### Community 259 - "smartcentr-site/src/lib/orders/order.ts"
Cohesion: 0.28
Nodes (11): POST(), getProfile(), isDemoPhone(), createOrder(), applyBonus(), DeliveryMethod, deliveryPriceFor(), OrderError (+3 more)
...
Cohesion: 0.17
Nodes (14): allowed(), BASE_FRONTS, baseKey(), BY_CODE, CODE, DRAWER_PARTS, frontsFromQuery(), frontsToQuery() (+6 more)

### Community 272 - "smartcentr-site/src/lib/cart/CartProvider.tsx"
Cohesion: 0.28
...
### Community 276 - "check_installments.py"
Cohesion: 0.21
...
### Community 277 - "Что сделано на MacBook 21.09.2026 — читать PC первым делом"
Cohesion: 0.20
...
### Community 278 - "smartcentr-site/scripts/sync-catalog.mjs"
Cohesion: 0.29
Nodes (6): apiUrl, CATALOG, fileEnv, log(), main(), ROOT

### Community 279 - "src/components/FilterSelect.tsx"
Cohesion: 0.38
Nodes (6): src_components_filter_select, FilterSelect(), choose(), keyboard(), show(), Option

### Community 289 - "smartcentr-site/src/components/kitchen/three/photoreal.ts"
Cohesion: 0.13
Nodes (12): ref_three_addons_postprocessing_pass_js, ref_three_gpu_pathtracer, DAY, Look, NIGHT, PhotoLights, PrepareOpts, DAY (+4 more)

### Community 306 - "smartcentr-site/src/lib/assistant/knowledge.ts"
Cohesion: 0.13
Nodes (20): smartcentr_site_src_data_contacts_yearsonmarket, budgetFrom(), cheaperThan(), NOT_UNIT, PATTERNS, THOUSAND, CustomerBrief, expand() (+12 more)
...
### Community 345 - "src/app/api/customer/route-helpers.ts"
Cohesion: 0.15
Nodes (21): ref_next_headers, POST(), DELETE(), GET(), currentSession(), endSession(), POST(), POST() (+13 more)
...
Cohesion: 0.07
Nodes (27): ref_node_fs_promises, ref_node_path, ref_sharp, ref_vitest_config, files, variants, androidDir, circle() (+19 more)
...
## Knowledge Gaps
- **957 isolated node(s):** `dynamic`, `FREE_DELIVERY_POINTS`, `Reply`, `Channel`, `STAFF_ACK` (+952 more)
...
- **Why does `KitchenEngine` connect `KitchenEngine` to `smartcentr-site/src/components/kitchen/three/photoreal.ts`, `.invalidate`, `.setKitchen`, `src/lib/kitchen/layout.ts`, `src/lib/kitchen/spec.ts`, `src/components/kitchen/three/engine.ts`, `src/components/kitchen/KitchenPlanner.tsx`, `PhotoTracer`, `src/components/kitchen/three/governor.ts`, `.constructor`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `formatSom()` connect `formatSom` to `smartcentr-site/src/components/CatalogView.tsx`, `smartcentr-site/src/lib/telegram/order.ts`, `smartcentr-site/src/lib/assistant/respond.ts`, `smartcentr-site/src/components/AccountView.tsx`, `smartcentr-site/src/lib/assistant/local.ts`, `smartcentr-site/src/components/kitchen/KitchenPlanner.tsx`, `smartcentr-site/src/app/[lang]/layout.tsx`, `smartcentr-site/src/lib/assistant/knowledge.ts`, `useI18n`, `smartcentr-site/src/components/AssistantChat.tsx`, `ref_react`, `smartcentr_site_src_data_products`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `KitchenPlanner()` connect `src/components/kitchen/KitchenPlanner.tsx` to `kitchen.test.ts`, `src/components/kitchen/three/build.ts`, `src/app/[lang]/layout.tsx`, `.invalidate`, `.setKitchen`, `formatSom`, `src/lib/kitchen/layout.ts`, `src/lib/kitchen/spec.ts`, `src/components/kitchen/three/engine.ts`, `KitchenEngine`, `src/components/ProductPurchase.tsx`, `src/lib/kitchen/fronts.ts`, `useI18n`, `src/components/kitchen/pdfSheet.ts`, `src/lib/kitchen/checks.ts`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **What connects `dynamic`, `FREE_DELIVERY_POINTS`, `Reply` to the rest of the system?**
