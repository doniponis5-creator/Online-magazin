...
## Summary
- 2136 nodes · 4818 edges · 178 communities (98 shown, 80 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 120 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3905f814`
...
## Communities (178 total, 80 thin omitted)
...
### Community 3 - "isLang"
Cohesion: 0.06
Nodes (33): nextConfig, next, metadata, src_app_globals, generateMetadata(), generateMetadata(), generateMetadata(), generateMetadata() (+25 more)
...
Cohesion: 0.10
Nodes (27): AccountView(), formatDate(), src_components_home_merchandising, AppLockPlugin, CapacitorGlobal, forgetFaceId(), hasLockKey(), lockKind() (+19 more)

### Community 8 - "useI18n"
Cohesion: 0.11
Nodes (38): ref_next_link, react, CartPage(), CheckoutPage(), FieldErrors, FavoritesPage(), OrderView(), src_components_account (+30 more)
...
Cohesion: 0.11
Nodes (43): app_models, AsyncSession, BaseModel, BonusAccount, Decimal, get, Интернет-магазин Smart Centr: заказы с сайта (O!Деньги → 1С)., _account() (+35 more)
...
### Community 15 - "text"
Cohesion: 0.14
Nodes (28): httpx, text(), _b64(), _bundle(), _devices(), _drop(), enabled(), _fail() (+20 more)
...
Cohesion: 0.10
Nodes (48): AsyncClient, account_delete(), AccountDelete, _as_list(), _attention(), _clean(), _daily(), dashboard() (+40 more)

### Community 20 - "telegram/order.ts"
Cohesion: 0.09
Nodes (46): ASK_PHONE, BAD_PHONE, CALL_INTENT, cancelLead(), Draft, drafts, FAILED, hasLead() (+38 more)

### Community 21 - "vitest"
Cohesion: 0.11
Nodes (8): widths, ref_node_assert_strict, ref_node_fs, @playwright/test, vitest, assert, { chromium }, fs
...
Cohesion: 0.10
Nodes (21): ref_next_navigation, LangLayout(), viewport, generateMetadata(), ProductPage(), Header(), MotionProvider(), VisitCounter() (+13 more)
...
Cohesion: 0.14
Nodes (20): collections, date, build_rows(), _day(), _money(), _one_phone(), parse_phones(), _purchase() (+12 more)
...
Cohesion: 0.12
Nodes (29): app_core_database, datetime, fastapi, _as_jpeg(), chat_extra_items(), photos_index(), public_photo(), AsyncSession (+21 more)
...
Cohesion: 0.10
Nodes (23): ref_next_image, DevGalleryFixturePage(), Gallery(), ProductArt(), ProductDetail(), askText(), ProductPurchase(), StockLine() (+15 more)
...
### Community 90 - "errorResponse"
Cohesion: 0.42
Nodes (8): clientIp(), errorResponse(), POST(), POST(), POST(), sendCode(), waLoginStart, normalizePhone()

### Community 91 - "products.ts"
Cohesion: 0.06
Nodes (43): dynamic, SnapshotItem, CategoryTiles(), HomePage(), InfoStrip(), NightBanner(), ProductSection(), BrandLogo() (+35 more)

### Community 92 - "logging"
Cohesion: 0.29
Nodes (7): app_payments, Интернет-магазин Smart Centr — сообщение в WhatsApp с кнопкой. Зачем. Раньше в…, Отправить сообщение, а ссылку показать кнопкой. Возвращает True, если ушло с…, Обычное сообщение. Ошибку не прячем: выше её ловит вызывающий., _send_plain(), send_with_button(), logging
...
Cohesion: 0.09
Nodes (34): CustomerBrief, storeFacts(), allOutSay, Answer, bonusText(), dayText(), foundSay, helloText() (+26 more)
...
Cohesion: 0.13
Nodes (12): getpass, Кабинет SBonus (cabinet.smartcentr.store): вход через WhatsApp «наоборот».…, main(), patch(), Кабинет SBonus — страница входа: кнопка «Войти через WhatsApp». Правит…, os, Path, pathlib (+4 more)
...
Cohesion: 0.13
Nodes (24): categoryName(), fromJson(), withoutIds(), budgetFrom(), cheaperThan(), NOT_UNIT, PATTERNS, THOUSAND (+16 more)
...
Cohesion: 0.12
Nodes (31): ref_node_crypto, ref_server_only, dynamic, POST(), productsFromOneC(), followUp, ChatTurn, dailyLimit() (+23 more)
...
## Knowledge Gaps
- **368 isolated node(s):** `customer`, `order`, `Вход через WhatsApp «наоборот» (главное за вечер)`, `Бонус виден покупателю`, `Проверить после выкатки (PC)` (+363 more)
...
- **What connects `customer`, `order`, `Вход через WhatsApp «наоборот» (главное за вечер)` to the rest of the system?**
