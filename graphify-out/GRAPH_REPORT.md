...
Cohesion: 0.10
Nodes (19): HomePage(), src_data_1c_catalog, categories, Category, CategoryId, demoCategories, ArtKind, byIds() (+11 more)
...
Cohesion: 0.08
Nodes (30): generateMetadata(), generateMetadata(), generateMetadata(), generateMetadata(), generateMetadata(), metadata, PrivacyPage(), metadata (+22 more)
...
Cohesion: 0.21
Nodes (20): AboutPage(), metadata, BonusPromo(), Brand(), BrandMark(), ContactButton(), Footer(), IconPhone() (+12 more)
...
Cohesion: 0.12
Nodes (33): react, frameUrl(), Hero3D(), src_components_home_story, base(), IconArrowDown(), IconArrowUpRight(), IconCard() (+25 more)
...
Cohesion: 0.14
Nodes (4): @playwright/test, { chromium }, fs, path
...
Cohesion: 0.14
Nodes (22): CartPage(), DevGalleryFixturePage(), FavoritesPage(), generateMetadata(), ProductPage(), AddToCartButton(), BottomNav(), CartReminder() (+14 more)

### Community 25 - "useI18n"
Cohesion: 0.12
Nodes (27): A09 · P2 — Дизайн ҳужжати ва токенлар амалдаги бош баннердан ортда қолган, CategoryTiles(), InfoStrip(), NightBanner(), ProductSection(), BrandLogo(), hasBrandImage(), LOGOS (+19 more)

### Community 26 - "[lang]/layout.tsx"
Cohesion: 0.12
Nodes (14): LangLayout(), viewport, Header(), MotionProvider(), OfflineCatalogSync(), VisitCounter(), visitorId(), products (+6 more)
...
### Community 28 - "next"
Cohesion: 0.19
Nodes (10): nextConfig, next, Gallery(), ProductArt(), ProductImage(), QuantityStepper(), ProductPhoto, I18nContext (+2 more)
...
### Community 39 - "checkout/page.tsx"
Cohesion: 0.05
Nodes (57): vitest, CheckoutPage(), FieldErrors, OrderView(), CustomerLogin(), Step, ProductDetail(), ProductPurchase() (+49 more)
...
### Community 74 - "ref_node_fs"
Cohesion: 0.22
Nodes (6): widths, ref_node_fs, fs, path, root, sharp
...
### Community 89 - "normalize_builtin_photos.cjs"
Cohesion: 0.40
...
### Community 96 - "PromoCountdown.tsx"
Cohesion: 0.83
...
Cohesion: 0.05
Nodes (77): ref_server_only, POST(), DELETE(), GET(), GET(), POST(), POST(), clientIp() (+69 more)

### Community 135 - "ref_node_path"
Cohesion: 0.10
Nodes (17): ref_node_path, sharp, path, root, sharp, jobs, path, root (+9 more)
...
## Knowledge Gaps
- **325 isolated node(s):** `phone`, `laptop`, `catalog`, `order`, `base` (+320 more)
