...
7. `formatSom()` - 19 edges
8. `ShopOrder` - 18 edges
9. `getProduct()` - 18 edges
10. `isLang()` - 18 edges
...
## Communities (141 total, 61 thin omitted)
...
Cohesion: 0.05
Nodes (50): area(), box(), camera(), digit(), look_at(), LG F4X5ES5SB — внешняя модель по официальным фото, не заводской CAD. blender…, weighted(), Листы проверки: только кадрирование/одинаковая высота, без ретуши модели. (+42 more)
...
### Community 5 - "useI18n"
Cohesion: 0.10
Nodes (35): A09 · P2 — Дизайн ҳужжати ва токенлар амалдаги бош баннердан ортда қолган, CategoryTiles(), HomePage(), InfoStrip(), NightBanner(), ProductSection(), BrandLogo(), hasBrandImage() (+27 more)
...
Cohesion: 0.09
Nodes (16): ProductDetail(), brands, catalogSource, colorHexOf(), ColorOption, comboVariant(), defaultColorKey(), defaultMemoryKey() (+8 more)

### Community 9 - "shop_models.py"
Cohesion: 0.22
...
Cohesion: 0.13
Nodes (37): app_payments, asyncio, BonusAccount, Decimal, hmac, _account(), branch_id(), _code_hash() (+29 more)
...
Cohesion: 0.10
Nodes (39): ref_next_link, react, FavoritesPage(), FavoriteButton(), frameUrl(), Hero3D(), src_components_home_story, base() (+31 more)
...
Cohesion: 0.10
Nodes (9): widths, ref_node_assert_strict, ref_node_fs, @playwright/test, { chromium }, path, assert, { chromium } (+1 more)
...
Cohesion: 0.08
Nodes (7): ref_next_image, DevGalleryFixturePage(), Gallery(), ProductImage(), ProductPhoto, ArtKind, Product
...
Cohesion: 0.16
Nodes (24): AboutPage(), metadata, BonusPromo(), Brand(), ContactButton(), Footer(), IconInstagram(), IconPhone() (+16 more)
...
### Community 50 - "data/categories.ts"
Cohesion: 0.20
Nodes (8): ref_node_crypto, dynamic, SnapshotItem, src_data_1c_catalog, categories, Category, CategoryId, demoCategories
...
### Community 55 - "currentSession"
Cohesion: 0.33
Nodes (7): POST(), GET(), currentSession(), POST(), deleteAccount(), isDemoPhone(), registerPushDevice()

### Community 56 - "normalizePhone"
Cohesion: 0.42
Nodes (7): clientIp(), POST(), POST(), demoProfile(), sendCode(), verifyCode(), normalizePhone()

### Community 57 - "errorResponse"
Cohesion: 0.38
Nodes (9): DELETE(), GET(), POST(), POST(), endSession(), errorResponse(), startSession(), getProfile() (+1 more)
...
### Community 74 - "shop_catalog.py"
Cohesion: 0.16
Nodes (18): app_core_database, fastapi, hashlib, _as_jpeg(), photos_index(), public_photo(), AsyncSession, Request (+10 more)
...
### Community 90 - "render-svg.cjs"
Cohesion: 0.29
Nodes (6): ref_fs, ref_path, { chromium }, DIR, fs, path

### Community 92 - "[lang]/layout.tsx"
Cohesion: 0.16
...
Cohesion: 0.17
Nodes (9): ref_node_fs_promises, ref_node_path, sharp, ref_vitest_config, files, variants, { chromium }, fs (+1 more)
...
### Community 133 - "checkout/page.tsx"
Cohesion: 0.13
Nodes (25): CartPage(), CheckoutPage(), FieldErrors, OrderView(), src_components_account, AddToCartButton(), BottomNav(), CustomerLogin() (+17 more)
...
## Knowledge Gaps
- **266 isolated node(s):** `config`, `BonusHistoryItem`, `CodeChannel`, `CustomerOrderItem`, `MockCustomer` (+261 more)
...
- **What connects `config`, `BonusHistoryItem`, `CodeChannel` to the rest of the system?**
