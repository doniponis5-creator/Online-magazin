...
## Communities (174 total, 70 thin omitted)

### Community 0 - "orders/order.ts"
Cohesion: 0.16
Nodes (15): POST(), dynamic, GET(), demoProducts, getSiteSettings(), createOrder(), applyBonus(), DeliveryMethod (+7 more)
...
### Community 3 - "isLang"
Cohesion: 0.09
Nodes (27): generateMetadata(), generateMetadata(), generateMetadata(), generateMetadata(), generateMetadata(), metadata, PrivacyPage(), metadata (+19 more)
...
Cohesion: 0.09
Nodes (39): react, CartPage(), CheckoutPage(), FieldErrors, DevGalleryFixturePage(), OrderView(), generateMetadata(), src_components_account (+31 more)

### Community 9 - "normalize_builtin_photos.cjs"
Cohesion: 0.40
Nodes (4): fs, path, root, sharp

### Community 10 - "shop_customers.py"
Cohesion: 0.15
Nodes (36): BonusAccount, Decimal, _account(), branch_id(), _code_hash(), _customer(), get_profile(), max_spend() (+28 more)
...
Cohesion: 0.12
Nodes (31): frameUrl(), Hero3D(), base(), IconArrowDown(), IconCard(), IconCart(), IconCheck(), IconChevronLeft() (+23 more)
...
### Community 15 - "text"
Cohesion: 0.16
Nodes (24): base64, text(), photos_index(), public_photo(), _b64(), _bundle(), _devices(), _drop() (+16 more)
...
### Community 20 - "AssistantChat.tsx"
Cohesion: 0.14
Nodes (28): AboutPage(), metadata, src_components_assistant_chat, AssistantChat(), onKeyDown(), send(), handoffText(), Hit (+20 more)

### Community 21 - "@playwright/test"
Cohesion: 0.13
Nodes (11): @playwright/test, { chromium }, fs, path, dynamic, esc(), GET(), page() (+3 more)
...
Cohesion: 0.10
Nodes (33): A09 · P2 — Дизайн ҳужжати ва токенлар амалдаги бош баннердан ортда қолган, CategoryTiles(), HomePage(), InfoStrip(), NightBanner(), ProductSection(), BrandLogo(), hasBrandImage() (+25 more)

### Community 26 - "reply.ts"
Cohesion: 0.18
Nodes (17): fromJson(), withoutIds(), cheaperThan(), askGemini(), ChatTurn, geminiConfigured(), GeminiError, once() (+9 more)
...
### Community 28 - "bot.ts"
Cohesion: 0.09
Nodes (45): dynamic, POST(), ASK_PHONE, BAD_PHONE, CALL_INTENT, cancelLead(), Draft, drafts (+37 more)
...
Cohesion: 0.16
Nodes (18): dynamic, ipOf(), POST(), seen, tooOften(), dynamic, POST(), fileFor() (+10 more)
...
### Community 39 - "prepare_open_dishwasher_photos.cjs"
Cohesion: 0.40
Nodes (4): keys, path, root, sharp

### Community 40 - "shop_router.py"
Cohesion: 0.08
Nodes (53): api_route, app_core_config, Base, fastapi_responses, Сколько клиент платит деньгами (для старых заказов без бонусов — total)., Для страницы заказа на сайте: без телефона и адреса., Для 1С: всё, что нужно для Заказа клиента, ПКО и Реализации., ShopOrder (+45 more)
...
### Community 45 - "next"
Cohesion: 0.09
Nodes (22): nextConfig, next, LangLayout(), viewport, ProductPage(), ALLOW, ASSISTANTS, PRIVATE (+14 more)
...
Cohesion: 0.13
Nodes (29): app_core_database, AsyncClient, fastapi, _as_jpeg(), chat_extra_items(), AsyncSession, Request, Интернет-магазин Smart Centr — каталог и фото: 1С → сервер → сайт. 1С… (+21 more)

### Community 56 - "shop_wa_bot.py"
Cohesion: 0.12
Nodes (29): app_core_redis, asyncio, hmac, _site_base_url(), _answer(), _ask_for_text(), _ask_site(), _auto_reply() (+21 more)
...
Cohesion: 0.06
Nodes (33): dynamic, SnapshotItem, Gallery(), ProductArt(), ProductDetail(), src_data_1c_catalog, categories, Category (+25 more)
...
Cohesion: 0.10
Nodes (32): catalogForQuestion(), CustomerBrief, storeFacts(), allOutSay, Answer, bonusText(), dayText(), foundSay (+24 more)
...
Cohesion: 0.14
Nodes (22): vitest, products, lookupIn(), ASK_ADDRESS, ASK_NAME, ASK_PHONE, ASK_PICK, ASK_WHERE (+14 more)
...
### Community 163 - "shop_telegram.py"
Cohesion: 0.17
Nodes (14): app_payments, httpx, enabled(), Интернет-магазин Smart Centr — код входа через Telegram Gateway. Зачем: код в…, Отправить код входа в Telegram. True — доставлено в Telegram, False — нет…, send_code(), sender(), token() (+6 more)
...
## Knowledge Gaps
- **415 isolated node(s):** `customer`, `phone`, `laptop`, `catalog`, `order` (+410 more)
