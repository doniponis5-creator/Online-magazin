...
|---|---|---|---|
| 2026-09-24 | `2026-09-24-kitchen-3d-mobile-security` | сдан | Конструктор кухни: сайт не встроить в чужой, прокси фото по белому списку; на телефоне виды под 3D, «Ещё» словом, полный экран с панелью; 3D подстраивается под мощность устройства |
