...
|---|---|---|---|
| 2026-09-24 | `2026-09-24-kitchen-3d-mobile-security` | сдан | Конструктор кухни: сайт не встроить в чужой, прокси фото по белому списку; на телефоне виды под 3D, «Ещё» словом, полный экран с панелью; 3D подстраивается под мощность устройства, «Лёгкий» режим для слабых телефонов |
| 2026-09-25 | `2026-09-25-android-app` | сдан | Android-приложение проверено на эмуляторе Android 16 и на Samsung A55: «Нет связи» теперь видит «Каталог» и «Бонусную карту», заставка в цвет иконки, карта/отпечаток/выход/тестовая оплата работают; файл для Google Play `smarket-1.0-code3.aab`, инструкция без неточностей |
