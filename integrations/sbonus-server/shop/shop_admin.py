...
SETTINGS: list[dict] = [
    ...
    {
        "key": "SITE_CHAT_MARKUP_PCT",
        "title": "Наценка на товары не с сайта (продаёт чат), %",
        "hint": "Чат предлагает товар со склада, которого нет на сайте, по цене: себестоимость + этот процент "
                "(если у товара есть цена сайта — по ней). 0 — такие товары чат не предлагает.",
        "type": "number",
        "min": 0,
        "max": 300,
        "default": "0",
